...
class Invoices extends Component {
    ...
    cancelInvoice = (e, invoiceID) => {
        e.preventDefault();
        this.invoiceService.cancelInvoice(invoiceID).then(res => {
            this.removeInvoiceFromStateAfterCancelling(invoiceID)
    ...
    removeInvoiceFromStateAfterCancelling = (invoiceID) => {
    ...
    goToInvoiceDetails = (e, invoiceid) => {
        var path = "/employee/invoice-details/" + invoiceid;
                                    ...
                                    return (
                                        <tr key={key} className="flex inherit-all">
                                            ...
                                            <td
                                                ...
                                                <Button className="bg-gray details-invoice white no-border" onClick={e => this.goToInvoiceDetails(e, prop.invoiceID)} > Details </Button>
                                            </td>
                                            <td
                                                className="flex-no-shrink flex-basis-10-perc flex-grow-1"
                                                key={key + 'atr' + 10}>

                                                <Button className="bg-red delete-invoice white no-border" onClick={e => this.cancelInvoice(e, prop.invoiceID)} >Cancel </Button>
                                            </td>
                                        </tr>
                                    );
                                })
